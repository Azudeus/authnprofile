...
public class GetProfileAsync extends AsyncTask<String,String, JSONObject> {
    private static final String LIST_URL = "https://dev.prelo.id/api/me/lovelist";
    ...
    protected JSONObject doInBackground(String... args){
        try {
            ...
            conn.setRequestProperty("Authorization","Token "+args[0]);
